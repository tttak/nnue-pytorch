...
class Features(FeatureBlock):
  def __init__(self):
    super(Features, self).__init__('HalfKP_KK', 0x5d69d5b8 ^ (0x6C72E637 << 1) ^ (0x6C72E637 >> 31), OrderedDict([('HalfKP_KK', 125388 + 6561)]))

  def get_active_features(self, board: chess.Board):
    def piece_features(turn):
      indices = torch.zeros(125388 + 6561)
...
class FactorizedFeatures(FeatureBlock):
  def __init__(self):
    super(FactorizedFeatures, self).__init__('HalfKP_KK^', 0x5d69d5b8 ^ (0x6C72E637 << 1) ^ (0x6C72E637 >> 31), OrderedDict([('HalfKP_KK', 125388 + 6561), ('HalfK', NUM_SQ), ('P', NUM_PLANES )]))
    self.base = Features()
