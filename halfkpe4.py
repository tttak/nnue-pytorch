...
class Features(FeatureBlock):
  def __init__(self):
    super(Features, self).__init__('HalfKPE4', 0x5d69d5b8, OrderedDict([('HalfKPE4', NUM_PLANES * NUM_SQ * 4)]))
...
class FactorizedFeatures(FeatureBlock):
  def __init__(self):
    super(FactorizedFeatures, self).__init__('HalfKPE4^', 0x5d69d5b8, OrderedDict([('HalfKPE4', NUM_PLANES * NUM_SQ * 4), ('HalfK', NUM_SQ), ('P', NUM_PLANES )]))
    self.base = Features()
