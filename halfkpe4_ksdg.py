...
class Features(FeatureBlock):
  def __init__(self):
    super(Features, self).__init__('HalfKPE4_KSDG', 0x5d69d5b8 ^ (0x596B2374 << 1) ^ (0x596B2374 >> 31), OrderedDict([('HalfKPE4_KSDG', 177876 * 4 + 12672)]))

  def get_active_features(self, board: chess.Board):
    def piece_features(turn):
      indices = torch.zeros(177876 * 4 + 12672)
...
class FactorizedFeatures(FeatureBlock):
  def __init__(self):
    super(FactorizedFeatures, self).__init__('HalfKPE4_KSDG^', 0x5d69d5b8 ^ (0x596B2374 << 1) ^ (0x596B2374 >> 31), OrderedDict([('HalfKPE4_KSDG', 177876 * 4 + 12672), ('HalfK', NUM_SQ), ('P', NUM_PLANES )]))
    self.base = Features()
