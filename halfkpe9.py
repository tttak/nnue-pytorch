...
class Features(FeatureBlock):
  def __init__(self):
    super(Features, self).__init__('HalfKPE9', 0x5d69d5b8, OrderedDict([('HalfKPE9', NUM_PLANES * NUM_SQ * 9)]))
...
class FactorizedFeatures(FeatureBlock):
  def __init__(self):
    super(FactorizedFeatures, self).__init__('HalfKPE9^', 0x5d69d5b8, OrderedDict([('HalfKPE9', NUM_PLANES * NUM_SQ * 9), ('HalfK', NUM_SQ), ('P', NUM_PLANES )]))
    self.base = Features()
