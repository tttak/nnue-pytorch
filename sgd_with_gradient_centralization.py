...
class SGDWithGradientCentralization(Optimizer):
    ...
    def __init__(
        ...
        super(SGDWithGradientCentralization, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(SGDWithGradientCentralization, self).__setstate__(state)
